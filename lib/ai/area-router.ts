...
const RULES: { area: Exclude<Area, "mixed">; kw: string[] }[] = [
  { area: "E", kw: ["결정", "그만둘지", "포기할지", "할지 말지", "비용", "돈 걱정", "돈이", "지원금", "안 되면"] },
  { area: "D", kw: ["남편", "아내", "배우자", "싸웠", "싸움", "갈등", "서운", "오해"] },
  { area: "C", kw: ["우울", "불안", "무너", "힘들", "지쳐", "번아웃", "외로", "눈물"] },
  { area: "B", kw: ["AMH", "수치가", "수치는", "수치를", "수치 결과", "초음파", "난포", "정액검사", "혈액검사", "배아", "착상", "결과지", "호르몬"] },
  { area: "A", kw: ["먹어도", "마셔도", "커피", "음주", "운동", "음식", "영양제", "습관", "괜찮을까"] },
];
